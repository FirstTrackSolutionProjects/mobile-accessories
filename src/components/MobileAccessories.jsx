...
const MobileAccessories = () => {
    return (
        <section className="mobile-accessories">
            <h2>What Can You Buy From Us?</h2>
            ...
            <p>
                ...
                Looking for high-performance laptops? Our <a href="/">Back to College Store</a> 
            ...
            <h3>Protective Cases and Covers</h3>
    <p>
    ...
    <h3>Wireless Headphones and Earbuds</h3>
    <p>
